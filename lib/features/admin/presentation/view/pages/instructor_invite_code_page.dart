...
@RoutePage()
class InstructorInviteCodePage extends StatefulWidget {
  const InstructorInviteCodePage({super.key, this.initialCode});

  final String? initialCode;

  @override
  State<InstructorInviteCodePage> createState() =>
      _InstructorInviteCodePageState();
}

class _InstructorInviteCodePageState extends State<InstructorInviteCodePage> {
  ...
  Widget _buildCodeCard() {
    ...
    return Container(
      ...
      child: Column(
        children: [
          // QR Code Card with integrated top bar (Status, Copy & Share) and centered code
          Center(
            child: QrCard(
          ...
          // Action Button: Generate New Code (when permitted)
          CustomButton(
            title: LocaleKeys.settings_extra_admin_generate_new_code.tr(),
            isFilled: true,
            isGradient: false,
