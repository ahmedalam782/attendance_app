...
class PhoneHelper {
  ...
  static List<CountryModel> getAllCountries(String locale) {
    return _countryPhoneLengths.keys.map((code) {
      return CountryModel(
        code: code,
        name: getCountryTitle(code, locale),
        length: _countryPhoneLengths[code]!,
      );
    }).toList();
  }
